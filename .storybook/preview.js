...
import { ThemeProvider } from "../src/browser/contexts/ThemeContext";
import "../src/browser/styles/globals.css";
import { TUTORIAL_STATE_KEY, RIGHT_SIDEBAR_COLLAPSED_KEY, EXPANDED_PROJECTS_KEY, WORKSPACE_DRAFTS_BY_PROJECT_KEY, } from "../src/common/constants/storage";
...
function ensureStorybookFontsReady() {
    fontsReadyPromise ?? (fontsReadyPromise = (async () => {
...
const preview = {
    ...
    decorators: [
        ...
        (Story, context) => {
            ...
            return (_jsx(ThemeProvider, { forcedTheme: mode, children: _jsx(Story, {}) }));
        },
    ],
    parameters: {
        controls: {
