 ...
 */
export const CompactionWarning = (props) => {
    ...
    const showForceCompactCountdown = props.isStreaming && willCompactNext && props.usagePercentage < forceCompactThreshold;
    ...
    return (_jsx("div", { className: "mx-4 mt-2 mb-1 text-right text-[10px]", children: _jsx("button", { type: "button", onClick: props.onCompactClick, className: `cursor-pointer hover:underline ${isUrgent ? "text-plan-mode font-semibold" : "text-muted"}`, title: "Click to insert /compact command", children: text }) }));
};
//# sourceMappingURL=CompactionWarning.js.map