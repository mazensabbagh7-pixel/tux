                        ...
                        >
                          ...
                          <Popover>
                            ...
                            <PopoverContent align="start" side="bottom" sideOffset={4} className="w-52 p-1">
                              ...
                              <button className="text-foreground bg-background hover:bg-hover w-full rounded-sm px-2 py-1.5 text-left text-xs whitespace-nowrap" onClick={(e) => { e.stopPropagation(); handleCreateSection(projectPath, "New section"); }}>New section</button>
