...
function getTooltipContent(animationState, lastRefreshInfo) {
...
describe("RefreshButton tooltip content", () => {
    ...
    test("shows idle content WITH lastRefreshInfo when set", () => {
        const info = { timestamp: Date.now(), trigger: "manual" };
...
//# sourceMappingURL=RefreshButton.test.js.map