...
describe("SelectableDiffRenderer review notes", () => {
    it("should extract correct line content for review notes", () => {
        ...
        const lineData = [
            { index: 0, type: "add", lineNum: 1 },
            { index: 1, type: "add", lineNum: 2 },
            { index: 2, type: "context", lineNum: 3 },
        ];
    ...
    it("should handle removal lines correctly", () => {
        ...
        const lines = content.split("\n").filter((line) => line.length > 0);
        const lineData = [
            { index: 0, type: "remove", lineNum: 10 },
            { index: 1, type: "add", lineNum: 10 },
        ];
    ...
    it("should handle context lines correctly", () => {
        ...
        const lines = content.split("\n").filter((line) => line.length > 0);
        const lineData = [
            { index: 0, type: "context", lineNum: 5 },
            { index: 1, type: "add", lineNum: 6 },
        ];
    ...
    it("should handle multiline selection correctly", () => {
        ...
        const lineData = [
            { index: 0, type: "add", lineNum: 1 },
            { index: 1, type: "add", lineNum: 2 },
            { index: 2, type: "add", lineNum: 3 },
            { index: 3, type: "context", lineNum: 4 },
        ];
