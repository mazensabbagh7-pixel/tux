...
import { SPLASH_REGISTRY, DISABLE_SPLASH_SCREENS } from "./index";
import { useAPI } from "@/browser/contexts/API";
const SplashScreenActiveContext = createContext(false);
export function useIsSplashScreenActive() {
...
export function SplashScreenProvider({ children }) {
    ...
    return (_jsxs(SplashScreenActiveContext.Provider, { value: isSplashScreenActive, children: [children, loaded && currentSplash && _jsx(currentSplash.component, { onDismiss: () => void dismiss() })] }));
}
//# sourceMappingURL=SplashScreenProvider.js.map