...
describe("sanitizeImageData", () => {
    it("should allow safe image types", () => {
        ...
        expect(sanitizeImageData("image/png", validBase64)).toBe(`data:image/png;base64,${validBase64}`);
        expect(sanitizeImageData("image/jpeg", validBase64)).toBe(`data:image/jpeg;base64,${validBase64}`);
        expect(sanitizeImageData("image/gif", validBase64)).toBe(`data:image/gif;base64,${validBase64}`);
        expect(sanitizeImageData("image/webp", validBase64)).toBe(`data:image/webp;base64,${validBase64}`);
    });
    ...
    it("should reject excessively large data", () => {
        const hugeData = "A".repeat(16000000); // 16MB
...
//# sourceMappingURL=ToolResultImages.test.js.map