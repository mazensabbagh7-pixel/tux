...
import { allowsEscapeToInterruptStream, matchesKeybind, KEYBINDS, isEditableElement, isTerminalFocused, } from "@/browser/utils/ui/keybinds";
 ...
 */
export function useAIViewKeybinds({ workspaceId, canInterrupt, showRetryBarrier, chatInputAPI, jumpToBottom, handleOpenTerminal, handleOpenInEditor, aggregator, setEditingMessage, vimEnabled, }) {
    const { api } = useAPI();
    useEffect(() => {
        const handleInterruptKeyDown = (e) => {
            ...
            if (matchesKeybind(e, interruptKeybind) && !isTerminalFocused(e.target)) {
                ...
                if (interruptKeybind === KEYBINDS.INTERRUPT_STREAM_NORMAL &&
...
//# sourceMappingURL=useAIViewKeybinds.js.map