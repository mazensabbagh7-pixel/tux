 ...
 */
export function getTitlebarLeftInset() {
    if (!isDesktopMode())
        return 0;
    if (getDesktopPlatform() === "darwin")
        return MAC_TRAFFIC_LIGHTS_INSET;
    return 0;
}
/**
 ...
 */
export function getTitlebarRightInset() {
    if (!isDesktopMode())
        return 0;
    const platform = getDesktopPlatform();
    if (platform === "win32" || platform === "linux")
        return WIN_LINUX_OVERLAY_INSET;
    return 0;
}
/**
 ...
 * ```
 */
export function initTitlebarInsets() {
...
//# sourceMappingURL=useDesktopTitlebar.js.map