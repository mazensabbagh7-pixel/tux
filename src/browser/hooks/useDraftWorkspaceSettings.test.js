...
describe("useDraftWorkspaceSettings", () => {
    ...
    test("does not reset selected runtime to the default while editing SSH host", async () => {
        ...
        const wrapper = (props) => (_jsx(APIProvider, { client: createStubApiClient(), children: _jsx(ThinkingProvider, { projectPath: projectPath, children: props.children }) }));
    ...
    test("persists Coder default string when toggling default", async () => {
        ...
        const defaultRuntimeString = readPersistedState(getRuntimeKey(projectPath), undefined);
...
//# sourceMappingURL=useDraftWorkspaceSettings.test.js.map