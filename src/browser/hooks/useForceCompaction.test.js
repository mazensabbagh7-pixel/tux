...
import { useForceCompaction } from "./useForceCompaction";
describe("useForceCompaction", () => {
    ...
    test("does NOT trigger double compaction when continue message starts after compaction", () => {
        ...
        const { rerender } = renderHook((props) => useForceCompaction(props), {
            initialProps: {
                shouldForceCompact: true,
                canInterrupt: true,
                isCompacting: false,
...
//# sourceMappingURL=useForceCompaction.test.js.map