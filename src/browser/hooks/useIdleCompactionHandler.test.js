...
let executeCompactionCalls = [];
let executeCompactionResult = {
    success: true,
};
let executeCompactionResolver = null;
...
describe("useIdleCompactionHandler", () => {
    ...
    test("subscribes to onIdleCompactionNeeded on mount", () => {
        renderHook(() => useIdleCompactionHandler({
            api: mockApi,
    ...
    test("unsubscribes on unmount", () => {
        const { unmount } = renderHook(() => useIdleCompactionHandler({
            api: mockApi,
            _executeCompaction: mockExecuteCompaction,
            _getSendOptionsFromStorage: mockGetSendOptionsFromStorage,
        }));
...
//# sourceMappingURL=useIdleCompactionHandler.test.js.map