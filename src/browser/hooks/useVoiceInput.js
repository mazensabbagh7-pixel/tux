...
const HAS_GET_USER_MEDIA = typeof window !== "undefined" &&
...
export function useVoiceInput(options) {
    ...
    const transcribe = useCallback(async (audioBlob) => {
        ...
        try {
            ...
            const base64 = btoa(new Uint8Array(buffer).reduce((str, byte) => str + String.fromCharCode(byte), ""));
    ...
    const start = useCallback(async () => {
        ...
        const canStart = HAS_MEDIA_RECORDER &&
            HAS_GET_USER_MEDIA &&
            !HAS_TOUCH_DICTATION &&
            state === "idle" &&
        ...
        try {
            ...
            callbacksRef.current.onError?.(isPermissionDenied
...
//# sourceMappingURL=useVoiceInput.js.map