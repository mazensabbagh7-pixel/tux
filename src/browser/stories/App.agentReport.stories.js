...
import { blurActiveElement, waitForChatInputAutofocusDone, waitForScrollStabilization, } from "./storyPlayHelpers";
 ...
 */
export const AgentReportToolCall = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("a1", "Here's my final report:", {
                    ...
                    toolCalls: [
                        createGenericTool("tc1", "agent_report", {
                            title: "Agent report",
...
//# sourceMappingURL=App.agentReport.stories.js.map