...
import { STABLE_TIMESTAMP, createAssistantMessage, createGenericTool, createUserMessage, } from "./mockFactory";
import { blurActiveElement, waitForChatInputAutofocusDone, waitForChatMessagesLoaded, waitForScrollStabilization, } from "./storyPlayHelpers";
import { userEvent, waitFor } from "@storybook/test";
export default {
    ...appMeta,
    title: "App/Agent Skill Tools",
};
async function expandFirstToolCall(canvasElement) {
...
const SKILLS_WITH_UNADVERTISED = [
    {
        name: "pull-requests",
        description: "Guidelines for creating and managing Pull Requests in this repo",
        scope: "project",
...
export const SkillIndicator_AllScopes = {
...
export const SkillIndicator_UnadvertisedSkills = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
    ...
    play: async ({ canvasElement }) => {
        ...
        await waitFor(() => {
            ...
            if (!eyeOffIcon)
                throw new Error("EyeOff icon not found for unadvertised skill");
        });
        await waitForChatInputAutofocusDone(canvasElement);
        blurActiveElement();
    },
...
export const SkillIndicator_InvalidSkills = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
export const SkillIndicator_LoadErrors = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("a1", "Trying to load skills:", {
                    ...
                    toolCalls: [
                        createGenericTool("tc1", "agent_skill_read", { name: "deployment" }, {
                            success: false,
                            error: "Agent skill not found: deployment",
                        }),
                        createGenericTool("tc2", "agent_skill_read", { name: "staging-env" }, {
                            success: false,
...
export const SkillIndicator_AllErrors = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
// SKILL TOOL CALLS
// ═══════════════════════════════════════════════════════════════════════════════
export const AgentSkillRead_Collapsed = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("a1", "Reading skill:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 59000,
                    toolCalls: [
                        createGenericTool("tc1", "agent_skill_read", { name: "react-effects" }, { success: true, skill: SKILL_PACKAGE }),
                    ],
                }),
            ],
        }) })),
...
export const AgentSkillRead_Expanded = {
...
export const AgentSkillReadFile_Collapsed = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("a1", "Reading file:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 59000,
                    toolCalls: [
                        createGenericTool("tc1", "agent_skill_read_file", { name: "react-effects", filePath: "references/README.md", offset: 1, limit: 5 }, {
                            success: true,
                            file_size: 250,
...
export const AgentSkillReadFile_Expanded = {
...
//# sourceMappingURL=App.agentSkills.stories.js.map