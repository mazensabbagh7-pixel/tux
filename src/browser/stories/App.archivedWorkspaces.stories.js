 ...
 */
export const WorkspaceNameInRuntimeTooltip = {
    ...
    play: async ({ canvasElement }) => {
        ...
        const checkbox = await canvas.findByLabelText("Select Fix agent report rendering", {}, {
            timeout: 10000,
        });
        ...
        const runtimeBadge = runtimeIcon.closest("span");
        if (!runtimeBadge) {
        ...
        await waitFor(() => {
            ...
            const tooltipWithin = within(tooltip);
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows a ProjectPage with archived workspaces; hovering the worktree badge displays the workspace name when a custom title is set.",
            },
        },
    },
};
//# sourceMappingURL=App.archivedWorkspaces.stories.js.map