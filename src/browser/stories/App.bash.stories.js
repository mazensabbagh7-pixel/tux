...
import { STABLE_TIMESTAMP, createUserMessage, createAssistantMessage, createBashTool, createBashOverflowTool, createPendingTool, createBackgroundBashTool, createMigratedBashTool, createBashOutputTool, createBashOutputErrorTool, createBashBackgroundListTool, createBashBackgroundTerminateTool, } from "./mockFactory";
import { setupSimpleChatStory } from "./storyHelpers";
import { blurActiveElement, waitForChatInputAutofocusDone, waitForChatMessagesLoaded, } from "./storyPlayHelpers.js";
 ...
 */
async function expandAllBashTools(canvasElement) {
    ...
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Let me check the git status and run tests:", {
                    ...
                    toolCalls: [
                        createBashTool("call-1", `#!/bin/bash
set -e
...
export const OverflowNotice = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Scanning logs (output too large, saved to temp file):", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 135000,
                    toolCalls: [
                        createBashOverflowTool("call-1", 'rg "ERROR" /var/log/app/*.log', [
 ...
 */
export const BackgroundWorkflow = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-4", "Dev server output:", {
                    ...
                    toolCalls: [
                        createBashOutputTool("call-3", "bash_1", "  VITE v5.0.0  ready in 320 ms\n\n  ➜  Local:   http://localhost:5173/\n  ➜  Network: use --host to expose", "running"),
                    ],
                }),
                ...
                createAssistantMessage("msg-6", "Build completed:", {
                    ...
                    toolCalls: [
                        createBashOutputTool("call-4", "bash_2", "vite v5.0.0 building for production...\n✓ 1423 modules transformed.\ndist/index.html   0.46 kB │ gzip:  0.30 kB\n✓ built in 2.34s", "exited", 0),
                    ],
                }),
                ...
                createAssistantMessage("msg-8", "Filtered errors and checking for updates:", {
                    ...
                    toolCalls: [
                        createBashOutputTool("call-5", "bash_1", "[ERROR] Failed to connect to database\n[ERROR] Retry attempt 1 failed", "running", undefined, "ERROR"),
...
export const Mixed = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll run the quick one normally and the long one in background.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 290000,
                    toolCalls: [
                ...
                createAssistantMessage("msg-4", "Running tests:", {
                    ...
                    toolCalls: [
                        ...
                        createMigratedBashTool("call-3", "npm run test:integration", "test-suite", "Integration Tests", "Running integration tests...\nTest 1: PASS\nTest 2: PASS\nTest 3: Running..."),
                    ],
                }),
                ...
                createAssistantMessage("msg-6", "The build failed:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        createBashOutputTool("call-4", "bash_6", "FAIL src/utils.test.ts\n  ✕ should parse dates correctly (5 ms)\n\nTests: 1 failed, 1 total", "exited", 1),
                    ],
                }),
            ],
        }) })),
            ...
            messages: [
                ...
                createAssistantMessage("msg-4", "Monitoring server output:", {
                    ...
                    toolCalls: [
                        ...
                        createBashOutputTool("call-6", "bash_1", "  VITE v5.0.0  ready in 320 ms\n\n  ➜  Local:   http://localhost:5173/", "running"),
                    ],
                }),
    ...
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Starting CI checks:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 390000,
                    toolCalls: [
                        createBackgroundBashTool("call-1", "./scripts/wait_pr_checks.sh 1081", "bash_ci", "Wait PR Checks"),
                    ],
                }),
                ...
                createAssistantMessage("msg-4", "Waiting for CI with filter_exclude to skip progress messages:", {
                    historySequence: 4,
                    timestamp: STABLE_TIMESTAMP - 290000,
                    toolCalls: [
                        // First call - using filter_exclude to skip ⏳ lines
                        createBashOutputTool("call-2", "bash_ci", "", // No meaningful output yet (⏳ lines were excluded)
                        "running", undefined, "⏳", // filter pattern
                        60, // long timeout
                        true // filter_exclude = true
                        ),
                        // Second call - still waiting, excluded lines don't wake us
                        createBashOutputTool("call-3", "bash_ci", "✅ All checks passed!\n\n🤖 Checking for unresolved Codex comments...\n\n✅ PR is ready to merge!", "exited", 0, "⏳", 60, true),
                    ],
                }),
                ...
                createAssistantMessage("msg-6", "Regular filter only shows matching lines:", {
                    ...
                    toolCalls: [
                        ...
                        createBashOutputTool("call-4", "bash_ci", "ERROR: Build failed\nERROR: Test suite failed", "exited", 1, "ERROR", // filter pattern (include mode)
                        5, false // filter_exclude = false (default)
                        ),
                    ],
                }),
            ],
...
//# sourceMappingURL=App.bash.stories.js.map