...
import { STABLE_TIMESTAMP, createUserMessage, createAssistantMessage, createCompactionRequestMessage, createFileReadTool, createFileEditTool, createTerminalTool, createStatusTool, createGenericTool, createPendingTool, createProposePlanTool, createWebSearchTool, createBashTool, createAgentSkillReadTool, withHookOutput, } from "./mockFactory";
...
export const WithLoadedSkills = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll load the testing skill to follow project conventions.", {
                    historySequence: 2,
                ...
                createAssistantMessage("msg-3", "I'll also load the React effects skill since this is a React component.", {
                    historySequence: 3,
                ...
                createAssistantMessage("msg-4", "Now I can write tests that follow your project's testing patterns.", {
                    historySequence: 4,
...
export const WithSkillCommand = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll review the effect with the react-effects skill and report any stale closure risks.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 110000,
                }),
            ],
...
export const Conversation = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll help you add authentication. Let me search for best practices first.", {
                    historySequence: 2,
                ...
                createAssistantMessage("msg-3", "Great, let me check the current implementation.", {
                    ...
                    toolCalls: [
                        createFileReadTool("call-1", "src/api/users.ts", "export function getUser(req, res) {\n  const user = db.users.find(req.params.id);\n  res.json(user);\n}"),
                    ],
                }),
                ...
                createAssistantMessage("msg-5", "I'll add JWT validation. Here's the update:", {
                    ...
                    toolCalls: [
                        createFileEditTool("call-2", "src/api/users.ts", [
                            "--- src/api/users.ts",
                            "+++ src/api/users.ts",
                            "@@ -1,5 +1,15 @@",
...
export const SyntheticAutoResumeMessages = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll run the tests now. Let me spawn a sub-agent to handle the test execution.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 295000,
                }),
                createUserMessage("msg-3", "You have active background sub-agent task(s) (task-abc123). " +
                ...
                createUserMessage("msg-5", "Your background sub-agent task(s) have completed. Use task_await to retrieve their reports and integrate the results.", {
                    historySequence: 5,
                    timestamp: STABLE_TIMESTAMP - 280000,
                    synthetic: true,
                }),
                createAssistantMessage("msg-6", "The sub-agent has finished. All 47 tests passed successfully — no failures found.", {
                    historySequence: 6,
...
export const WithReasoning = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Good catch! We should add try-catch error handling around the JWT verification.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 90000,
                    reasoning: "The user is asking about error handling for JWT verification. The verifyToken function could throw if the token is malformed or if there's an issue with the secret. I should wrap it in a try-catch block and return a proper error response.",
                }),
                createAssistantMessage("msg-3", "Cache is warm, shifting focus to documentation next.", {
                    historySequence: 3,
    ...
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Running the test suite now:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        createTerminalTool("call-1", "npm test", [
                ...
                createAssistantMessage("msg-3", "Here's a failing test for comparison:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 80000,
                    toolCalls: [
                        createTerminalTool("call-2", "npm test -- --testNamePattern='edge case'", [
...
export const WithAgentStatus = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I've created PR #1234 with the authentication changes.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        createStatusTool("call-1", "🚀", "PR #1234 waiting for CI", "https://github.com/example/repo/pull/1234"),
                    ],
                }),
            ],
        }) })),
...
export const VoiceInputNoApiKey = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [],
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the voice input button in disabled state when OpenAI API key is not configured. Hover over the mic icon in the chat input to see the user education tooltip.",
            },
        },
    },
};
...
export const Streaming = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupStreamingChatStory({
            messages: [
...
export const AskUserQuestionPending = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
    ...
    play: async ({ canvasElement }) => {
        ...
        const getSectionButton = async (prefix) => {
            const buttons = await canvas.findAllByRole("button");
            const btn = buttons.find((el) => el.tagName === "BUTTON" && (el.textContent ?? "").startsWith(prefix));
            if (!btn)
                throw new Error(`${prefix} section button not found`);
            return btn;
        };
        ...
        try {
            ...
            const toolContainerText = toolTitle.closest("div")?.parentElement?.textContent?.slice(0, 500) ?? "<missing>";
            throw new Error(`AskUserQuestionPending: question UI not found. Tool container: ${toolContainerText}`);
        }
...
export const AskUserQuestionCompleted = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                createUserMessage("msg-1", "Please implement the feature", {
                    historySequence: 1,
                ...
                createAssistantMessage("msg-2", "I asked some questions.", {
                    ...
                    toolCalls: [
                        createGenericTool("call-ask-1", "ask_user_question", {
                            questions: [
                                {
                                    question: "Which approach should we take?",
                                    header: "Approach",
 ...
 */
export const AskUserQuestionOther = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "Let me ask a few questions.", {
                    ...
                    toolCalls: [
                        createPendingTool("call-ask-1", "ask_user_question", {
                            ...
                            answers: {
                                "Describe your use case in detail": "I'm building a complex application.\nIt needs web, CLI, and API support.\nThe architecture should be modular.",
                            },
                        }),
                    ],
                }),
    ...
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll fetch that data for you.", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 55000,
                    toolCalls: [
                        createGenericTool("call-1", "fetch_data", {
                            endpoint: "/api/users",
...
export const StreamingCompaction = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupStreamingChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I've analyzed the codebase and made several improvements to the architecture.", {
                    historySequence: 2,
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the compaction shimmer effect during streaming. The shimmer uses GPU-accelerated CSS transforms instead of background-position animations to prevent frame drops.",
            },
        },
    },
};
/** Streaming compaction with configure hint - shows when no compaction model is set */
export const StreamingCompactionWithConfigureHint = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            return setupStreamingChatStory({
                ...
                messages: [
                    ...
                    createAssistantMessage("msg-2", "I've been helping with various tasks on this project.", {
                        historySequence: 2,
                        timestamp: STABLE_TIMESTAMP - 200000,
                    }),
                    createCompactionRequestMessage("msg-3", {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Shows the "configure" hint link in the streaming barrier during compaction when no custom compaction model is set. Clicking it opens Settings → Models.',
            },
        },
    },
};
...
export const BackgroundProcesses = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            messages: [
                ...
                createAssistantMessage("msg-2", "I've started the dev server and test runner in the background. You can continue working while they run.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 50000,
                    toolCalls: [
                        createTerminalTool("call-1", "npm run dev &", "Starting dev server on port 3000..."),
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the background processes banner when there are running background bash processes. Click the banner to expand and see process details or terminate them.",
            },
        },
    },
};
...
export const ModeHelpTooltip = {
    ...
    play: async ({ canvasElement }) => {
        ...
        const helpIndicator = helpIndicators.find((el) => el.tagName === "SPAN" && el.className.includes("cursor-help"));
        if (!helpIndicator)
            throw new Error("HelpIndicator not found");
    ...
    parameters: {
        docs: {
            description: {
                story: "Verifies the HelpIndicator tooltip works by focusing the ? icon. The tooltip should appear with Exec/Plan mode explanations.",
            },
        },
    },
};
 ...
 */
export const ModelSelectorPrettyWithGateway = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
    ...
    play: async ({ canvasElement }) => {
        ...
        const gatewayIndicator = await waitFor(() => {
            ...
            if (!el)
                throw new Error("Gateway indicator not found");
            return el;
        }, { interval: 50 });
    ...
    parameters: {
        docs: {
            description: {
                story: "Verifies the bottom-left model selector stays pretty (e.g. GPT-4o) even when mux-gateway routing is enabled.",
            },
        },
    },
};
 ...
 */
export const ModelSelectorDropdownOpen = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
    ...
    parameters: {
        docs: {
            description: {
                story: "Model selector dropdown open, showing gateway toggle and default star icons properly aligned without gaps.",
            },
        },
    },
};
...
export const EditingMessage = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            return setupSimpleChatStory({
                ...
                messages: [
                    ...
                    createAssistantMessage("msg-2", "I'll help you add authentication. Let me check the current implementation and add JWT validation.", {
                        historySequence: 2,
                        timestamp: STABLE_TIMESTAMP - 290000,
                        toolCalls: [
                            createFileReadTool("call-1", "src/api/users.ts", "export function getUser(req, res) {\n  const user = db.users.find(req.params.id);\n  res.json(user);\n}"),
                    ...
                    createAssistantMessage("msg-4", "Of course! I can use a different authentication approach. What would you prefer?", {
                        historySequence: 4,
                        timestamp: STABLE_TIMESTAMP - 270000,
                    }),
                ],
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the editing message state with the amber-styled input border and edit cutoff barrier indicating messages that will be removed.",
            },
        },
    },
};
 ...
 */
export const DiffPaddingColors = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Here are diffs with different first/last line types:", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        // Diff starting with addition - top padding should be green
                        createFileEditTool("call-1", "src/addition-first.ts", [
                        ...
                        createFileEditTool("call-2", "src/deletion-last.ts", [
                        ...
                        createFileEditTool("call-3", "src/context-both.ts", [
                            "--- src/context-both.ts",
                            "+++ src/context-both.ts",
                            "@@ -1,4 +1,4 @@",
                            " function before() {",
    ...
    parameters: {
        docs: {
            description: {
                story: "Verifies diff container padding colors match first/last line types. " +
 ...
 */
export const DiffPaddingAlignment = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Here's a diff ending with deletions at high line numbers:", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        // Diff with 3-digit line numbers ending in deletions
                        // Replicates the alignment issue from code review diffs
                        createFileEditTool("call-1", "src/ppo/train/config.rs", [
    ...
    parameters: {
        docs: {
            description: {
                story: "Verifies diff padding alignment with 3-digit line numbers. " +
 ...
 */
export const DiffHorizontalScroll = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Here's a diff with lines that require horizontal scrolling:", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        createFileEditTool("call-1", "src/config/longLines.ts", [
    ...
    parameters: {
        docs: {
            description: {
                story: "Verifies diff container scrolls horizontally for long lines. " +
...
export const InitHookSuccess = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the InitMessage component after a successful init hook execution. " +
...
export const InitHookError = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the InitMessage component after a failed init hook execution. " +
...
export const ContextMeterWithIdleCompaction = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll help you refactor the authentication module. Let me first review the current implementation.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 290000,
                    // High context usage to show the meter prominently (65% of 200k = 130k tokens)
                    contextUsage: { inputTokens: 130000, outputTokens: 2000 },
                    toolCalls: [
                        createFileReadTool("call-1", "src/auth/index.ts", 'export { login, logout, verifyToken } from "./handlers";'),
                    ],
                }),
            ],
        }) })),
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the Context Meter with high usage (~65%) and idle compaction enabled (4h). " +
...
export const ProposePlan = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll create a plan for refactoring the authentication module.", {
                    historySequence: 2,
                    timestamp: STABLE_TIMESTAMP - 290000,
                    toolCalls: [
                        createProposePlanTool("call-plan-1", `# Authentication Module Refactor
...
- Performance benchmarks maintained`),
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the ProposePlanToolCall component with a completed plan. " +
 ...
 */
export const ProposePlanMobile = {
    ...ProposePlan,
    parameters: {
        ...
        docs: {
            description: {
                story: "Renders ProposePlan at an iPhone-sized viewport to verify that Implement / Start Orchestrator " +
 ...
 */
export const ProposePlanWithLongCodeBlock = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I see the issue. Here's my plan to fix it:", {
                    ...
                    timestamp: STABLE_TIMESTAMP,
                    toolCalls: [
                        createProposePlanTool("call-plan-1", `# Fix CI Pipeline Failure
...
3. Add a pre-flight check to catch missing variables earlier`),
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests that code blocks within plans wrap correctly instead of overflowing. " +
 ...
 */
export const TodoWriteWithLongTodos = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Sure — here are the tasks:", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        createGenericTool("call-todo-1", "todo_write", {
                            todos: [
                                {
                                    content: "Create British-themed layout (HTML) matching reference: left nav, hero section, decorative flourishes, and a deliberately overlong description to force truncation in narrow layouts",
                                    status: "pending",
                                },
                                {
                                    content: "Implement grotesque Great Britain pride styling (Union Jack, red/white/blue palette, overly ornate typography) with enough detail to overflow a single line",
                                    status: "in_progress",
                                },
                                {
                                    content: "Add small JS for interactions (active nav, mobile drawer, hover effects, focus states, keyboard shortcuts, and more) — again intentionally verbose",
                                    status: "pending",
                                },
                                {
                                    content: "Run a local server and verify layout + responsiveness across breakpoints; include a comically long note about testing on multiple devices and ensuring no horizontal overflow",
                                    status: "pending",
                                },
                            ],
    ...
    parameters: {
        docs: {
            description: {
                story: "Regression test for long todo text overflowing its container. " +
 ...
 */
export const SigningBadgePassphraseWarning = {
    ...
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            signingCapabilities: {
                ...
                githubUser: null,
                error: {
                    message: "Signing key requires a passphrase. Create an unencrypted key at ~/.mux/message_signing_key or use ssh-add.",
    ...
    play: async ({ canvasElement }) => {
        ...
        await waitFor(() => {
            ...
            if (!popover)
                throw new Error("Share popover not found");
        });
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the signing badge in warning state (yellow) when a signing key exists but is passphrase-protected.",
            },
        },
    },
};
...
export const ToolHooksOutput = {
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "I'll fix the lint errors.", {
                    ...
                    toolCalls: [
                        ...
                        withHookOutput(createFileEditTool("call-1", "src/app.ts", [
                            "--- src/app.ts",
                            "+++ src/app.ts",
                            "@@ -1,3 +1,3 @@",
                            "-const x=1",
                            ...
                            " ",
                            " export default x;",
                        ].join("\n")), "prettier: reformatted src/app.ts\neslint: auto-fixed 2 issues", 145),
                        // Bash with failing hook (lint check failed)
                        withHookOutput(createBashTool("call-2", "npm run build", "Build complete.", 0, 30, 1500, "Build"), "post-build hook: running type check...\n✗ Found 1 type error:\n  src/utils.ts:42 - Type 'string' is not assignable to type 'number'", 2340),
                    ],
                }),
                createAssistantMessage("msg-3", "Let me also read the config file.", {
                    ...
                    toolCalls: [
                        ...
                        createFileReadTool("call-3", "tsconfig.json", '{\n  "compilerOptions": {\n    "strict": true\n  }\n}'),
                    ],
                }),
            ],
        }) })),
    parameters: {
        docs: {
            description: {
                story: "Shows tool hook output as a subtle expandable section below tool results. " +
...
export const ToolHooksOutputExpanded = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
            ...
            messages: [
                ...
                createAssistantMessage("msg-2", "Running the formatter.", {
                    ...
                    timestamp: STABLE_TIMESTAMP - 90000,
                    toolCalls: [
                        withHookOutput(createBashTool("call-1", "npx prettier --write .", "Formatted 15 files.", 0, 10, 800, "Prettier"), "post-hook: git status check\nM  src/app.ts\nM  src/utils.ts\nM  src/config.ts\n\n3 files modified by formatter", 85),
                    ],
                }),
            ],
        }) })),
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the hook output display in its expanded state, revealing the full hook output.",
            },
        },
    },
};
...
export const ContextSwitchWarning = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            return setupSimpleChatStory({
                ...
                messages: [
                    ...
                    createAssistantMessage("msg-2", "I've analyzed the codebase. Here's my refactoring plan...", {
                        historySequence: 2,
                        timestamp: STABLE_TIMESTAMP - 290000,
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the context switch warning banner. Previous message used Sonnet (150K tokens), " +
...
//# sourceMappingURL=App.chat.stories.js.map