...
async function openProjectCreationView(storyRoot) {
    ...
    const projectRow = await waitFor(() => {
        const el = storyRoot.querySelector('[data-project-path="/Users/dev/my-project"][aria-controls]');
        if (!el)
 ...
 */
export const SSHWithCoderAvailable = {
 ...
 */
export const CoderNewWorkspace = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderExistingWorkspace = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderExistingWorkspaceParseError = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderTemplatesParseError = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderPresetsParseError = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderNotAvailable = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const CoderNoRunningWorkspaces = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
...
//# sourceMappingURL=App.coder.stories.js.map