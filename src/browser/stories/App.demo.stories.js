...
import { NOW, STABLE_TIMESTAMP, createWorkspace, createSSHWorkspace, groupWorkspacesByProject, createUserMessage, createAssistantMessage, createFileReadTool, createFileEditTool, createTerminalTool, createStatusTool, createStaticChatHandler, createStreamingChatHandler, } from "./mockFactory";
import { createGitStatusExecutor, createOnChatAdapter, selectWorkspace, setWorkspaceInput, setWorkspaceModel, } from "./storyHelpers";
...
export const Comprehensive = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            const activeMessages = [
                ...
                createAssistantMessage("msg-2", "I'll help you add authentication. Let me check the current implementation.", {
                    historySequence: 2,
                ...
                createAssistantMessage("msg-6", "Running the test suite:", {
                    ...
                    toolCalls: [
                        createTerminalTool("call-3", "npm test", [
                ...
                createAssistantMessage("msg-7", "Tests pass! I've created a PR.", {
                    ...
                    toolCalls: [
                        createStatusTool("call-4", "🚀", "PR #1234 waiting for CI", "https://github.com/example/repo/pull/1234"),
                    ],
                }),
            ];
...
//# sourceMappingURL=App.demo.stories.js.map