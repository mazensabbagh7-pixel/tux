...
import { NOW, STABLE_TIMESTAMP, createWorkspace, createUserMessage, createAssistantMessage, createStaticChatHandler, groupWorkspacesByProject, } from "./mockFactory";
 ...
 */
function createPRStatusExecutor(prStatuses) {
...
export const PRStatusBadges = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            for (const ws of workspaces) {
                chatHandlers.set(ws.id, createStaticChatHandler([
...
export const LinksDropdown = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            ...
            const chatHandlers = new Map();
            chatHandlers.set("ws-with-links", createStaticChatHandler([
                createUserMessage("msg-1", "Add link support", {
                    historySequence: 1,
                    timestamp: STABLE_TIMESTAMP - 120000,
                }),
                createAssistantMessage("msg-2", `I'll help you add link support. Here are some relevant resources:
...
Let me check the implementation at https://github.com/coder/mux/blob/main/src/links.ts`, {
                ...
                createAssistantMessage("msg-4", `Found the tests at https://github.com/coder/mux/blob/main/src/links.test.ts
...
//# sourceMappingURL=App.links.stories.js.map