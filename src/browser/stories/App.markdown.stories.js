...
export const SingleLineCodeBlocks = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
    ...
    play: async ({ canvasElement }) => {
        ...
        for (const wrapper of codeWrappers) {
            const buttons = wrapper.querySelectorAll(".code-copy-button, .code-run-button");
...
export const SqlWithDoubleUnderscore = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
export const CodeBlocks = {
    ...
    play: async ({ canvasElement }) => {
        ...
        const container = await waitFor(() => {
            const found = Array.from(canvasElement.querySelectorAll(".code-block-container")).find((c) => c.textContent?.includes(url));
            if (!found)
...
export const UserMessageListSpacing = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
export const UserMessageCodeBlock = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
export const LongLinesOverflow = {
    render: () => (_jsx(AppWithMocks, { setup: () => setupSimpleChatStory({
...
//# sourceMappingURL=App.markdown.stories.js.map