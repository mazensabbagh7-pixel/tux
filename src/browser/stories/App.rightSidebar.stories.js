...
import { setupSimpleChatStory, setupStreamingChatStory, expandRightSidebar, setHunkFirstSeen, setReviewSortOrder, } from "./storyHelpers";
...
import { RIGHT_SIDEBAR_TAB_KEY, RIGHT_SIDEBAR_WIDTH_KEY, getRightSidebarLayoutKey, PREFERRED_COMPACTION_MODEL_KEY, getAutoCompactionThresholdKey, } from "@/common/constants/storage";
import { updatePersistedState } from "@/browser/hooks/usePersistedState";
export default {
    ...appMeta,
    title: "App/RightSidebar",
    decorators: [
        (Story) => (_jsx("div", { style: { width: 1600, height: "100dvh" }, children: _jsx(Story, {}) })),
    ],
    parameters: {
        ...appMeta.parameters,
        chromatic: {
 ...
 */
function createSessionUsage(cost) {
 ...
 */
export const CostsTabWithCacheCreate = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("costs"));
            localStorage.setItem("costsTab:viewMode", JSON.stringify("session"));
    ...
    play: async ({ canvasElement }) => {
        ...
        const costsTab = await canvas.findByRole("tab", { name: /^costs/i }, { timeout: 10000 });
 ...
 */
export const ExplorerTabSelected = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("explorer"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "350");
 ...
 */
export const StatsTabStreaming = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("stats"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "400");
            // Clear persisted layout to ensure stats tab appears in fresh default layout
 ...
 */
export const ReviewTabSortByLastEdit = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
    ...
    play: async ({ canvasElement }) => {
        ...
        const reviewTab = await canvas.findByRole("tab", { name: /^review/i }, { timeout: 10000 });
        await userEvent.click(reviewTab);
        await waitFor(() => {
            canvas.getByRole("tab", { name: /^review/i, selected: true });
        }, { timeout: 10000 });
 ...
 */
export const ReviewTabSortByFileOrder = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
 ...
 */
export const DiffPaddingAlignmentModification = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
 ...
 */
export const ReviewTabReadMore = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
 ...
 */
export const ReviewTabWithFileFilter = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
            const workspaceId = "ws-review-file-filter";
            // Set active file filter - this would be set when user clicks a file in tree
            localStorage.setItem(`review-file-filter:${workspaceId}`, JSON.stringify("src/components/Button.tsx"));
            const client = setupSimpleChatStory({
                workspaceId,
...
export const ReviewTabReadMoreBoundaries = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
 ...
 */
export const ReviewTabWithUntrackedFiles = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("review"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "700");
...
export const ManyTabsWrap = {
            ...
            updatePersistedState(getRightSidebarLayoutKey(workspaceId), {
                ...
                root: {
                    ...
                    tabs: [
                        ...
                        "explorer",
                        "stats",
                        ...Array.from({ length: 12 }, (_v, i) => `file:src/components/ThisIsAReallyLongFileName${i + 1}.tsx`),
                    ],
                    activeTab: "review",
                },
            });
    ...
    play: async ({ canvasElement }) => {
        const canvas = within(canvasElement);
        await canvas.findByRole("tablist", { name: /sidebar views/i }, { timeout: 10000 });
 ...
 */
export const CostsTabCompactionModelWarning = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("costs"));
            localStorage.setItem("costsTab:viewMode", JSON.stringify("session"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "400");
    ...
    parameters: {
        docs: {
            description: {
                story: "Shows the compaction model context warning when the configured compaction model (gpt-4o, 128k) " +
 ...
 */
export const OutputTabWithLogs = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("output"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "400");
 ...
 */
export const OutputTabErrorsOnly = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            localStorage.setItem(RIGHT_SIDEBAR_TAB_KEY, JSON.stringify("output"));
            localStorage.setItem(RIGHT_SIDEBAR_WIDTH_KEY, "400");
...
//# sourceMappingURL=App.rightSidebar.stories.js.map