...
async function openFirstProjectCreationView(storyRoot) {
...
export const CreateWorkspaceMultipleProjects = {
    parameters: {
        chromatic: {
            modes: {
                dark: { theme: "dark" },
 ...
 */
export const NonGitRepositorySuccess = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/new-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/new-project")]),
                ...
                gitInit: () => Promise.resolve({ success: true }),
            });
        } })),
    play: async ({ canvasElement }) => {
        const storyRoot = document.getElementById("storybook-root") ?? canvasElement;
 ...
 */
export const NonGitRepositoryInProgress = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/new-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/new-project")]),
 ...
 * when git init fails.
 */
export const NonGitRepositoryError = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/new-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/new-project")]),
 ...
 */
export const DockerUnavailable = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/new-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/new-project")]),
...
function generateArchivedWorkspaces(projectPath, projectName) {
    const MINUTE = 60000;
    const HOUR = 3600000;
    const DAY = 86400000;
    const workspaces = [];
                ...
                : kind === 2
                    ...
                    : kind === 3
                        ...
                        : kind === 4
                            ...
                            : `bugfix/regression-${n}`;
        const id = `archived-${n}`;
        workspaces.push(createArchivedWorkspace({
            id,
            name,
            projectName,
            projectPath,
 ...
 */
export const ProjectPageWithArchivedWorkspaces = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            const { workspaces, sessionUsage } = generateArchivedWorkspaces("/Users/dev/my-project", "my-project");
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
                workspaces,
                sessionUsage,
 ...
 */
export const SingleProviderConfigured = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
 ...
 */
export const MultipleProvidersConfigured = {
    render: () => (_jsx(AppWithMocks, { setup: () => {
            expandProjects(["/Users/dev/my-project"]);
            return createMockORPCClient({
                projects: new Map([projectWithNoWorkspaces("/Users/dev/my-project")]),
...
//# sourceMappingURL=App.welcome.stories.js.map