...
export function createSSHWorkspace(opts) {
...
export function createLocalWorkspace(opts) {
    return createWorkspace({
        ...opts,
...
export function createIncompatibleWorkspace(opts) {
    return {
        ...createWorkspace(opts),
        incompatibleRuntime: opts.incompatibleReason ??
...
export function createArchivedWorkspace(opts) {
    return {
        ...createWorkspace(opts),
...
export function createProjectConfig(workspaces) {
    return {
...
export function groupWorkspacesByProject(workspaces) {
...
// MESSAGE FACTORY
// ═══════════════════════════════════════════════════════════════════════════════
export function createUserMessage(id, text, opts) {
...
export function createCompactionRequestMessage(id, opts) {
...
export function createAssistantMessage(id, text, opts) {
    const parts = [];
    if (opts.reasoning) {
    ...
    contextUsage.totalTokens ?? (contextUsage.totalTokens = contextUsage.inputTokens + contextUsage.outputTokens);
    return {
        type: "message",
        id,
        role: "assistant",
...
// TOOL CALL FACTORY
// ═══════════════════════════════════════════════════════════════════════════════
export function createFileReadTool(toolCallId, filePath, content) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "file_read",
...
export function createFileEditTool(toolCallId, filePath, diff) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createBashOverflowTool(toolCallId, script, notice, truncated, timeoutSecs = 3, durationMs = 50, displayName = "Bash") {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "bash",
...
export function createBashTool(toolCallId, script, output, exitCode = 0, timeoutSecs = 3, durationMs = 50, displayName = "Bash") {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "bash",
...
export function createWebSearchTool(toolCallId, query, resultCount = 5, encrypted = true) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "web_search",
...
export function createTerminalTool(toolCallId, command, output, exitCode = 0) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createStatusTool(toolCallId, emoji, message, url) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "status_set",
...
export function createPendingTool(toolCallId, toolName, args) {
...
export function createAgentSkillReadTool(toolCallId, skillName, opts = {}) {
...
export function createGenericTool(toolCallId, toolName, input, output) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName,
...
export function createProposePlanTool(toolCallId, planContent, planPath = ".mux/plan.md") {
 ...
 */
export function withHookOutput(toolPart, hookOutput, hookDurationMs) {
...
export function createCodeExecutionTool(toolCallId, code, result, nestedCalls) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createPendingCodeExecutionTool(toolCallId, code, nestedCalls) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "code_execution",
...
export function createBackgroundBashTool(toolCallId, script, processId, displayName = "Background", timeoutSecs = 60) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "bash",
...
export function createMigratedBashTool(toolCallId, script, processId, displayName = "Bash", capturedOutput, timeoutSecs = 30) {
    const outputLines = capturedOutput?.split("\n") ?? [];
    const outputSummary = outputLines.length > 20
...
export function createBashOutputTool(toolCallId, processId, output, status = "running", exitCode, filter, timeoutSecs = 5, filterExclude) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createBashOutputErrorTool(toolCallId, processId, error, timeoutSecs = 5) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "bash_output",
...
export function createBashBackgroundListTool(toolCallId, processes) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createBashBackgroundTerminateTool(toolCallId, processId, displayName) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createGitStatusOutput(fixture) {
...
export function createStaticChatHandler(messages) {
    return (callback) => {
        setTimeout(() => {
...
export function createTaskTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task",
...
export function createCompletedTaskTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task",
...
export function createPendingTaskTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task",
...
export function createFailedTaskTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task",
...
export function createTaskApplyGitPatchTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
...
export function createTaskAwaitTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task_await",
...
export function createTaskListTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
        toolName: "task_list",
...
export function createTaskTerminateTool(toolCallId, opts) {
    return {
        type: "dynamic-tool",
        toolCallId,
