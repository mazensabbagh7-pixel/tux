 ...
 */
export async function waitForChatMessagesLoaded(canvasElement) {
...
export async function waitForChatInputAutofocusDone(canvasElement) {
    await waitFor(() => {
 ...
 */
export async function waitForScrollStabilization(canvasElement) {
...
//# sourceMappingURL=storyPlayHelpers.js.map