...
export class TerminalSessionRouter {
     ...
     */
    handleTerminalQueries(sessionId, data) {
            ...
            try {
                ...
                for await (const msg of iterator) {
                    ...
                    if (msg.type === "screenState") {
                        ...
                        console.debug(`[TerminalRouter] Broadcasting screenState for ${sessionId} to ${currentSession.subscribers.size} subscribers`);
...
//# sourceMappingURL=TerminalSessionRouter.js.map