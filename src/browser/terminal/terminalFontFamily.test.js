...
describe("terminalFontFamily", () => {
    describe("formatCssFontFamilyList", () => {
        test("quotes names with spaces and preserves generic families", () => {
            expect(formatCssFontFamilyList("Geist Mono, ui-monospace, monospace")).toBe('"Geist Mono", ui-monospace, monospace');
        });
    ...
    describe("appendTerminalIconFallback", () => {
        test("appends Nerd Font Symbols when missing", () => {
            expect(appendTerminalIconFallback("ui-monospace, monospace")).toBe('ui-monospace, monospace, "Nerd Font Symbols"');
        });
        test("does not duplicate Nerd Font Symbols when already present", () => {
            expect(appendTerminalIconFallback('ui-monospace, "Nerd Font Symbols"')).toBe('ui-monospace, "Nerd Font Symbols"');
        });
...
//# sourceMappingURL=terminalFontFamily.test.js.map