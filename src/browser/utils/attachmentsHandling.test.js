...
import { generateAttachmentId, fileToChatAttachment, extractAttachmentsFromClipboard, extractAttachmentsFromDrop, processAttachmentFiles, } from "./attachmentsHandling";
...
describe("attachmentsHandling", () => {
    ...
    describe("extractAttachmentsFromDrop", () => {
        test("extracts image files from DataTransfer", () => {
            ...
            const files = extractAttachmentsFromDrop(mockDataTransfer);
            expect(files).toHaveLength(2);
            expect(files).toContain(mockFile1);
...
//# sourceMappingURL=attachmentsHandling.test.js.map