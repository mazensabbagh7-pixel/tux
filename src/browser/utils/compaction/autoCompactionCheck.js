 ...
 */
import { DEFAULT_AUTO_COMPACTION_THRESHOLD, FORCE_COMPACTION_BUFFER_PERCENT, } from "@/common/constants/ui";
 ...
 */
function getContextTokens(usage) {
 ...
 */
export function checkAutoCompaction(usage, model, use1M, threshold = DEFAULT_AUTO_COMPACTION_THRESHOLD, warningAdvancePercent = WARNING_ADVANCE_PERCENT) {
    ...
    const shouldShowWarning = Math.max(lastUsagePercentage, usagePercentage) >= thresholdPercentage - warningAdvancePercent;
    return {
        shouldShowWarning,
        shouldForceCompact,
        usagePercentage,
...
//# sourceMappingURL=autoCompactionCheck.js.map