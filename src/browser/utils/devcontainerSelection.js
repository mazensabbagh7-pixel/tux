 ...
 */
export function resolveDevcontainerSelection(params) {
    ...
    const configPath = selectedPath && configs.some((c) => c.path === selectedPath) ? selectedPath : configs[0].path;
    return {
        configPath,
        configs,
        uiMode: "dropdown",
...
//# sourceMappingURL=devcontainerSelection.js.map