...
import { resolveDevcontainerSelection, DEFAULT_DEVCONTAINER_CONFIG_PATH, } from "./devcontainerSelection";
    ...
    describe("non-devcontainer mode", () => {
        ...
        it("returns hidden when mode is local", () => {
            const result = resolveDevcontainerSelection({
                ...
                availabilityState: { status: "loaded", data: {} },
            });
            expect(result.uiMode).toBe("hidden");
            expect(result.isCreatable).toBe(true);
        });
...
//# sourceMappingURL=devcontainerSelection.test.js.map