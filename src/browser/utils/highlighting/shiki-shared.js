 ...
 */
export function mapToShikiLang(detectedLang) {
    const mapping = {
        text: "plaintext",
        sh: "bash",
 ...
 */
function isVisuallyEmptyShikiLine(lineHtml) {
...
export function extractShikiLines(html) {
...
//# sourceMappingURL=shiki-shared.js.map