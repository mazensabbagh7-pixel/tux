...
import { mcpHeaderRowsToRecord, mcpHeadersRecordToRows } from "./mcpHeaders";
describe("mcpHeaders", () => {
    ...
    test("rejects newline characters in header values", () => {
        const rows = [{ id: "1", name: "X-Test", kind: "text", value: "hello\nworld" }];
        const { validation } = mcpHeaderRowsToRecord(rows);
    ...
    test("ignores fully-empty rows but errors on value without name", () => {
        const emptyRow = { id: "1", name: "", kind: "text", value: "" };
        ...
        const badRow = { id: "2", name: "", kind: "text", value: "x" };
...
//# sourceMappingURL=mcpHeaders.test.js.map