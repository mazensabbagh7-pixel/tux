...
import { isBashOutputEvent, isCaughtUpMessage, isDeleteMessage, isInitEnd, isInitOutput, isInitStart, isMuxMessage, isQueuedMessageChanged, isReasoningDelta, isReasoningEnd, isRestoreToInput, isRuntimeStatus, isStreamAbort, isStreamDelta, isStreamEnd, isStreamError, isStreamStart, isToolCallDelta, isToolCallEnd, isToolCallStart, isUsageDelta, } from "@/common/orpc/types";
/**
 ...
 */
export function applyWorkspaceChatEventToAggregator(aggregator, event, options) {
    assert(aggregator, "applyWorkspaceChatEventToAggregator requires aggregator");
    assert(event && typeof event === "object", "applyWorkspaceChatEventToAggregator requires event object");
...
//# sourceMappingURL=applyWorkspaceChatEventToAggregator.js.map