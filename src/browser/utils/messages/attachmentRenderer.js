 ...
 */
export function renderAttachmentToContent(attachment) {
 ...
 */
export function renderAttachmentsToContent(attachments) {
...
export function renderAttachmentsToContentWithBudget(attachments, options) {
    ...
    for (const attachment of ordered) {
        ...
        const remainingForContent = remainingForBlock - SYSTEM_UPDATE_OPEN.length - SYSTEM_UPDATE_CLOSE.length;
        ...
        if (attachment.type === "edited_files_reference") {
            const { content, omittedFiles } = renderEditedFilesReferenceWithBudget(attachment, remainingForContent);
