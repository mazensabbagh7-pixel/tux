...
export function appendLiveBashOutputChunk(prev, chunk, maxBytes) {
    if (maxBytes <= 0) {
    ...
    if (normalizedText.length === 0 && !phaseChanged)
        return base;
...
export function toLiveBashOutputView(state) {
    return {
        stdout: state.stdout,
        stderr: state.stderr,
...
//# sourceMappingURL=liveBashOutputBuffer.js.map