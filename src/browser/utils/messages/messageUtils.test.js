...
import { shouldShowInterruptedBarrier, mergeConsecutiveStreamErrors, computeBashOutputGroupInfo, computeBashOutputGroupInfos, shouldBypassDeferredMessages, } from "./messageUtils";
...
describe("computeBashOutputGroupInfo", () => {
    ...
    function createBashOutputMessage(id, processId, historySequence) {
        return {
            type: "tool",
            id,
            historyId: `h-${id}`,
...
//# sourceMappingURL=messageUtils.test.js.map