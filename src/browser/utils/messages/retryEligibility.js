 ...
 */
function isForceAllRetryableEnabled() {
 ...
 */
function computeHasInterruptedStream(messages, pendingStreamStartTime = null, runtimeStatus = null) {
    ...
    if (pendingStreamStartTime !== null) {
        ...
        if (elapsed < PENDING_STREAM_START_GRACE_PERIOD_MS)
            return false;
    }
    ...
    return (lastMessage.type === "stream-error" ||
 ...
 */
export function getInterruptionContext(messages, pendingStreamStartTime = null, runtimeStatus = null, lastAbortReason = null) {
    const hasInterrupted = computeHasInterruptedStream(messages, pendingStreamStartTime, runtimeStatus);
    if (!hasInterrupted) {
...
export function hasInterruptedStream(messages, pendingStreamStartTime = null, runtimeStatus = null, lastAbortReason = null) {
 ...
 */
export function isEligibleForAutoRetry(messages, pendingStreamStartTime = null, runtimeStatus = null, lastAbortReason = null) {
    return getInterruptionContext(messages, pendingStreamStartTime, runtimeStatus, lastAbortReason)
        .isEligibleForAutoRetry;
}
//# sourceMappingURL=retryEligibility.js.map