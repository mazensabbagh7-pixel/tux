...
import { getLastNonDecorativeMessage, hasInterruptedStream, isEligibleForAutoRetry, isNonRetryableSendError, PENDING_STREAM_START_GRACE_PERIOD_MS, } from "./retryEligibility";
...
describe("isEligibleForAutoRetry", () => {
    ...
    describe("partial messages and user messages", () => {
        ...
        it("hides retry barrier for user-initiated abort (Ctrl+C)", () => {
            ...
            const lastAbortReason = { reason: "user", at: Date.now() };
        ...
        it("hides retry barrier for startup abort", () => {
            ...
            const lastAbortReason = { reason: "startup", at: Date.now() };
...
//# sourceMappingURL=retryEligibility.test.js.map