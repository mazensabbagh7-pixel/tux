 ...
 */
export function createFreshRetryState() {
    return {
        attempt: 0,
 ...
 */
export function createManualRetryState(currentAttempt) {
    return {
 ...
 */
export function createFailedRetryState(previousAttempt, error) {
    return {
...
//# sourceMappingURL=retryState.js.map