...
import { getAllowedProvidersForUi, getAllowedRuntimeModesForUi, getPolicyRuntimeIdFromParsedRuntime, isParsedRuntimeAllowedByPolicy, } from "./policyUi";
...
describe("policyUi", () => {
    ...
    test("runtime policy helpers distinguish ssh vs ssh+coder", () => {
        const policy = buildPolicy({ runtimes: ["ssh+coder"] });
        const sshHost = { mode: RUNTIME_MODE.SSH, host: "user@host" };
        const sshCoder = {
...
//# sourceMappingURL=policyUi.test.js.map