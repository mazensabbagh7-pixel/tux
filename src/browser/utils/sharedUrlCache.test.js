...
import { getSharedUrl, getShareData, setShareData, removeShareData, updateShareExpiration, } from "./sharedUrlCache";
...
describe("sharedUrlCache", () => {
    const makeShareData = (url, id = "abc123", mutateKey = "key123") => ({
        url,
        id,
        mutateKey,
        expiresAt: undefined,
...
//# sourceMappingURL=sharedUrlCache.test.js.map