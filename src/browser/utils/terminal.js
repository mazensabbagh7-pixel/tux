 ...
 */
export function openTerminalPopout(api, workspaceId, sessionId) {
    ...
    if (isBrowser) {
        ...
        window.open(`/terminal.html?${params.toString()}`, `terminal-${workspaceId}-${Date.now()}`, "width=1000,height=600,popup=yes");
    }
 ...
 */
export async function createTerminalSession(api, workspaceId, options) {
