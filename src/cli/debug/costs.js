 ...
 */
export async function costsCommand(workspaceId) {
    ...
    if (lastUsage) {
        const totalTokens = lastUsage.input.tokens +
    ...
    for (const consumer of stats.consumers) {
        ...
        const tokenDisplay = consumer.tokens >= 1000
        ...
        const breakdownInfo = consumer.fixedTokens && consumer.variableTokens
        ...
        console.log(`  ${namepadded}  ${tokensFormatted} ${percentageFormatted} ${bar}${breakdownInfo}`);
    }
