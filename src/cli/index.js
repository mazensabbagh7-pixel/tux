...
import { CLI_GLOBAL_FLAGS, detectCliEnvironment, getParseOptions, getSubcommand, isCommandAvailable, isElectronLaunchArg, } from "./argv";
...
if (subcommand === "run") {
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        for (const flag of versionFlags) {
            if (!CLI_GLOBAL_FLAGS.includes(flag)) {
