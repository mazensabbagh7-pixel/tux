 ...
 */
export function migrateLegacyMuxHome() {
 ...
 */
export function getMuxSrcDir(rootDir) {
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxSessionsDir(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxLogsDir(rootDir) {
    const root = rootDir ?? getMuxHome();
    return join(root, "logs");
}
export function getMuxPlansDir(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxConfigFile(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxProvidersFile(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxSecretsFile(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxProjectsDir(rootDir) {
    const root = rootDir ?? getMuxHome();
 ...
 * @param rootDir - Optional root directory (defaults to getMuxHome())
 */
export function getMuxExtensionMetadataPath(rootDir) {
    const root = rootDir ?? getMuxHome();
