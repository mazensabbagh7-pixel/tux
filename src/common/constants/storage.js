 ...
 */
export function getProjectScopeId(projectPath) {
 ...
 */
export function getPendingScopeId(projectPath) {
 ...
 */
export function getDraftScopeId(projectPath, draftId) {
 ...
 */
export function getMCPTestResultsKey(projectPath) {
 ...
 */
export function getArchivedWorkspacesKey(projectPath) {
 ...
 */
export function getMCPServersKey(projectPath) {
 ...
 */
export function getThinkingLevelKey(scopeId) {
 ...
 */
export function getWorkspaceAISettingsByAgentKey(workspaceId) {
 ...
 */
export function getWorkspaceNameStateKey(scopeId) {
 ...
 */
export function getInputAttachmentsKey(scopeId) {
 ...
 */
export function getPendingWorkspaceSendErrorKey(workspaceId) {
    return `pendingSendError:${workspaceId}`;
}
/**
 * Get the localStorage key for auto-retry preference for a workspace
 */
export function getAutoRetryKey(workspaceId) {
 ...
 */
export function getRetryStateKey(workspaceId) {
 ...
 */
export function getCancelledCompactionKey(workspaceId) {
 ...
 */
export function getAgentIdKey(scopeId) {
 ...
 */
export function getPinnedAgentIdKey(scopeId) {
 ...
 */
export function getDisableWorkspaceAgentsKey(scopeId) {
 ...
 */
export function getRuntimeKey(projectPath) {
 ...
 */
export function getTrunkBranchKey(projectPath) {
 ...
 */
export function getAgentsInitNudgeKey(projectPath) {
 ...
 */
export function getLastRuntimeConfigKey(projectPath) {
...
export const DEFAULT_TERMINAL_FONT_CONFIG = {
 ...
 */
export function getReviewStateKey(workspaceId) {
 ...
 */
export function getHunkFirstSeenKey(workspaceId) {
 ...
 */
export function getReviewExpandStateKey(workspaceId) {
 ...
 */
export function getReviewReadMoreKey(workspaceId) {
 ...
 */
export function getFileTreeExpandStateKey(workspaceId) {
 ...
 */
export function getNotifyOnResponseKey(workspaceId) {
 ...
 */
export function getNotifyOnResponseAutoEnableKey(projectPath) {
    return `notifyOnResponseAutoEnable:${projectPath}`;
}
export function getStatusStateKey(workspaceId) {
 ...
 */
export function getSessionTimingKey(workspaceId) {
 ...
 */
export function getWorkspaceLastReadKey(workspaceId) {
 ...
 */
export function getRightSidebarLayoutKey(workspaceId) {
 ...
 */
export function getTerminalTitlesKey(workspaceId) {
 ...
 */
export function getReviewSearchStateKey(workspaceId) {
 ...
 */
export function getReviewsKey(workspaceId) {
 ...
 */
export function getAutoCompactionEnabledKey(workspaceId) {
 ...
 */
export function getAutoCompactionThresholdKey(model) {
 ...
 */
export function getPlanContentKey(workspaceId) {
 ...
 */
export function getPostCompactionStateKey(workspaceId) {
 ...
 */
export function copyWorkspaceStorage(sourceWorkspaceId, destWorkspaceId) {
 ...
 */
export function migrateWorkspaceStorage(oldWorkspaceId, newWorkspaceId) {
