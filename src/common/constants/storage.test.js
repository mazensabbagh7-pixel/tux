...
import { copyWorkspaceStorage, deleteWorkspaceStorage, getDraftScopeId, getInputAttachmentsKey, } from "@/common/constants/storage";
class MemoryStorage {
    constructor() {
        this.map = new Map();
    }
...
describe("storage workspace-scoped keys", () => {
    ...
    test("getDraftScopeId formats scope id", () => {
        expect(getDraftScopeId("/Users/me/repo", "draft-123")).toBe("__draft__//Users/me/repo/draft-123");
    });
