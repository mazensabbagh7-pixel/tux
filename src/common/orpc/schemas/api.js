...
import { CompletedMessagePartSchema, SendMessageOptionsSchema, StreamEndEventSchema, UpdateStatusSchema, WorkspaceChatMessageSchema, } from "./stream";
import { LayoutPresetsConfigSchema } from "./uiLayouts";
import { TerminalCreateParamsSchema, TerminalResizeParamsSchema, TerminalSessionSchema, } from "./terminal";
...
import { AgentSkillDescriptorSchema, AgentSkillIssueSchema, AgentSkillPackageSchema, SkillNameSchema, } from "./agentSkill";
import { AgentDefinitionDescriptorSchema, AgentDefinitionPackageSchema, AgentIdSchema, } from "./agentDefinition";
import { MCPAddGlobalParamsSchema, MCPAddParamsSchema, MCPListParamsSchema, MCPRemoveGlobalParamsSchema, MCPRemoveParamsSchema, MCPServerMapSchema, MCPSetEnabledGlobalParamsSchema, MCPSetEnabledParamsSchema, MCPSetToolAllowlistGlobalParamsSchema, MCPSetToolAllowlistParamsSchema, MCPTestGlobalParamsSchema, MCPTestParamsSchema, MCPTestResultSchema, WorkspaceMCPOverridesSchema, } from "./mcp";
...
export const projects = {
    ...
    clone: {
        input: z
            ...
            .strict(),
        output: eventIterator(z.discriminatedUnion("type", [
...
export { coder, CoderInfoSchema, CoderPresetSchema, CoderTemplateSchema, CoderWorkspaceConfigSchema, CoderWorkspaceSchema, CoderWorkspaceStatusSchema, } from "./coder";
// Workspace
    ...
    backgroundBashes: {
        ...
        getOutput: {
            input: z.object({
                ...
                tailBytes: z.number().int().positive().max(1000000).optional(),
            }),
            output: ResultSchema(z.object({
                status: z.enum(["running", "exited", "killed", "failed"]),
                output: z.string(),
