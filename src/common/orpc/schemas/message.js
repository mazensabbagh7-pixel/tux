...
const CompactionEpochSchema = z.optional(z.preprocess((value) => typeof value === "number" && Number.isInteger(value) && value > 0 ? value : undefined, z.number().int().positive().or(z.undefined())));
