 ...
 */
export function getThinkingDisplayLabel(level, modelString) {
 ...
 */
export function getThinkingOptionLabel(level, modelString) {
 ...
 */
export function parseThinkingDisplayLabel(value) {
 ...
 */
export function parseThinkingInput(value) {
    const normalized = value.trim().toLowerCase();
 ...
 */
export const THINKING_LEVEL_SYNONYMS = {
    med: "medium",
};
export function coerceThinkingLevel(value) {
...
export function getAnthropicEffort(level) {
 ...
 */
export const GEMINI_THINKING_BUDGETS = {
    off: 0,
    low: 2048,
    medium: 8192,
