...
import { coerceThinkingLevel, getThinkingDisplayLabel, getThinkingOptionLabel, MAX_THINKING_INDEX, parseThinkingInput, } from "./thinking";
...
describe("parseThinkingInput", () => {
    ...
    test.each(["-1", "10", "99", "foo", "mediun", "1.5", "", "  "])("returns undefined for invalid input %j", (input) => {
