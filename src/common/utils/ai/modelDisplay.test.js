...
describe("formatModelDisplayName", () => {
    ...
    describe("Bedrock models", () => {
        test("formats Anthropic Claude models from Bedrock", () => {
            expect(formatModelDisplayName("global.anthropic.claude-sonnet-4-5-20250929-v1:0")).toBe("Sonnet 4.5");
            expect(formatModelDisplayName("us.anthropic.claude-opus-4-20250514-v1:0")).toBe("Opus 4");
            expect(formatModelDisplayName("anthropic.claude-3-5-sonnet-20240620-v1:0")).toBe("Sonnet 3.5");
        });
