...
describe("parseMuxDeepLink", () => {
    test("parses mux://chat/new", () => {
        const payload = parseMuxDeepLink("mux://chat/new/?project=mux&projectPath=%2Ftmp%2Frepo&projectId=proj_123&prompt=hello%20world&sectionId=sec_456");
    ...
    test("resolves deep-link project query by final path segment", () => {
        const resolved = resolveProjectPathFromProjectQuery(["/Users/mike/repos/mux", "/Users/mike/repos/cmux"], "mux");
        expect(resolved).toBe("/Users/mike/repos/mux");
    });
    test("falls back to substring match when no exact match exists", () => {
        const resolved = resolveProjectPathFromProjectQuery(["/Users/mike/repos/coder", "/Users/mike/repos/cmux"], "mux");
