...
import { findLatestCompactionBoundaryIndex, sliceMessagesFromLatestCompactionBoundary, } from "./compactionBoundary";
describe("findLatestCompactionBoundaryIndex", () => {
    ...
    it("ignores boundary markers with malformed compacted values", () => {
        const malformedCompactedBoundary = createMuxMessage("summary-malformed-compacted", "assistant", "malformed summary", {
            compactionBoundary: true,
            compactionEpoch: 99,
        });
