 ...
 */
export function sortProjectsByOrder(projects, order) {
 ...
 */
export function reorderProjects(currentOrder, allProjects, draggedPath, targetPath) {
 ...
 * project ordering.
 */
export function normalizeOrder(order, projects) {
 ...
 */
export function equalOrders(a, b) {
    if (a === b)
        return true;
