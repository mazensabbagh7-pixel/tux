...
function extractModelStats(data) {
    return {
        ...
        input_cost_per_token: typeof data.input_cost_per_token === "number" ? data.input_cost_per_token : 0,
        output_cost_per_token: typeof data.output_cost_per_token === "number" ? data.output_cost_per_token : 0,
 ...
 */
export function getModelStats(modelString) {
