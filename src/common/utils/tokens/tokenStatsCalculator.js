...
import { getTokenizerForModel, countTokensForData, getToolDefinitionTokens, } from "@/node/utils/main/tokenizer";
 ...
 */
export function extractToolOutputData(output) {
 ...
 */
export function isEncryptedWebSearch(toolName, data) {
 ...
 */
export function countEncryptedWebSearchTokens(data) {
 ...
 */
export function getConsumerInfoForToolCall(toolName, _input) {
    if (toolName === "task") {
        return {
            consumer: "task",
 ...
 */
export function collectUniqueToolNames(messages) {
 ...
 */
export async function fetchAllToolDefinitions(toolNames, model) {
 ...
 */
export function extractSyncMetadata(messages, model) {
 ...
 */
export function mergeResults(jobs, results, toolDefinitions, systemMessageTokens) {
 ...
 */
export async function calculateTokenStats(messages, model) {
