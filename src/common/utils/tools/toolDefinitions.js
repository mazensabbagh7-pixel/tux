...
import { BASH_HARD_MAX_LINES, BASH_MAX_LINE_BYTES, BASH_MAX_TOTAL_BYTES, STATUS_MESSAGE_MAX_LENGTH, WEB_FETCH_MAX_OUTPUT_BYTES, } from "@/common/constants/toolLimits";
...
// -----------------------------------------------------------------------------
const SubagentTypeSchema = z.preprocess((value) => (typeof value === "string" ? value.trim().toLowerCase() : value), AgentIdSchema);
const TaskAgentIdSchema = z.preprocess((value) => (typeof value === "string" ? value.trim().toLowerCase() : value), AgentIdSchema);
...
export const TOOL_DEFINITIONS = {
    ...
    file_read: {
        ...
        schema: z.preprocess(normalizeFilePath, z.object({
    ...
    file_edit_insert: {
        ...
        schema: z.preprocess(normalizeFilePath, z
            .object({
            path: FILE_TOOL_PATH,
            insert_before: z
                .string()
...
export function getToolSchemas() {
    return Object.fromEntries(Object.entries(TOOL_DEFINITIONS).map(([name, def]) => [
        name,
        {
            name,
 ...
 */
export function getAvailableTools(modelString, options) {
