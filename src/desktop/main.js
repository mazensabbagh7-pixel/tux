...
import { app, BrowserWindow, ipcMain as electronIpcMain, Menu, Tray, dialog, nativeImage, nativeTheme, screen, shell, } from "electron";
...
console.log(`Mux starting - version: ${VERSION.git ?? "(dev)"} (built: ${VERSION.buildTime ?? "dev-mode"})`);
...
if (gotTheLock) {
    void app.whenReady().then(async () => {
        try {
            ...
            dialog.showErrorBox("Startup Failed", `The application failed to start:\n\n${errorMessage}\n\nPlease check the console for details.`);
