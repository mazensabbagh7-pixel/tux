...
describe("DevcontainerRuntime.resolveContainerCwd", () => {
    ...
    it("rejects Windows drive letter paths and falls back to workspace", () => {
        const runtime = createRuntime({ remoteWorkspaceFolder: "/workspaces/project" });
        expect(resolveContainerCwd(runtime, "C:\\Users\\dev", "/host/workspace")).toBe("/workspaces/project");
    });
    it("rejects paths with backslashes and falls back to workspace", () => {
        const runtime = createRuntime({ remoteWorkspaceFolder: "/workspaces/project" });
        expect(resolveContainerCwd(runtime, "some\\path", "/host/workspace")).toBe("/workspaces/project");
    });
...
describe("DevcontainerRuntime.mapHostPathToContainer", () => {
    ...
    it("maps host workspace root to container workspace", () => {
        ...
        expect(mapHostPathToContainer(runtime, "/home/user/mux/project/branch")).toBe("/workspaces/project");
    });
    it("maps host subpath to container subpath", () => {
        ...
        expect(mapHostPathToContainer(runtime, "/home/user/mux/project/branch/src/file.ts")).toBe("/workspaces/project/src/file.ts");
    });
    it("normalizes Windows backslashes to forward slashes", () => {
        ...
        expect(mapHostPathToContainer(runtime, "C:\\Users\\dev\\mux\\project\\branch\\src\\file.ts")).toBe("/workspaces/project/src/file.ts");
    });
