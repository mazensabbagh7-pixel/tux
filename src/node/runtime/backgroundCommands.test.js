...
import { shellQuote, buildWrapperScript, buildSpawnCommand, buildTerminateCommand, parseExitCode, parsePid, } from "./backgroundCommands";
describe("backgroundCommands", () => {
    ...
    describe("buildWrapperScript", () => {
        it("builds script with trap, cd, and user script joined by &&", () => {
            ...
            expect(result).toBe(`__MUX_EXIT_CODE_PATH='/tmp/exit_code' && trap 'echo $? > "$__MUX_EXIT_CODE_PATH"' EXIT && cd '/home/user/project' && echo hello`);
        });
