...
export function formatDevcontainerLabel(configPath) {
...
export function buildDevcontainerConfigInfo(configs) {
 ...
 */
export async function scanDevcontainerConfigs(projectPath) {
    const configs = [];
