...
describe("formatDevcontainerLabel", () => {
    ...
    it("labels .devcontainer/devcontainer.json as default", () => {
        expect(formatDevcontainerLabel(".devcontainer/devcontainer.json")).toBe("Default (.devcontainer/devcontainer.json)");
    });
    it("labels nested devcontainer configs by folder", () => {
        expect(formatDevcontainerLabel(".devcontainer/backend/devcontainer.json")).toBe("backend (.devcontainer/backend/devcontainer.json)");
    });
    it("normalizes backslashes in nested paths", () => {
        expect(formatDevcontainerLabel(".devcontainer\\frontend\\devcontainer.json")).toBe("frontend (.devcontainer/frontend/devcontainer.json)");
    });
