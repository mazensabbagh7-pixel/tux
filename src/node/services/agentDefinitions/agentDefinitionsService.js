...
import { AgentDefinitionDescriptorSchema, AgentDefinitionFrontmatterSchema, AgentDefinitionPackageSchema, AgentIdSchema, } from "@/common/orpc/schemas";
...
import { AgentDefinitionParseError, parseAgentDefinitionMarkdown, } from "./parseAgentDefinitionMarkdown";
 ...
 */
export function agentVisitKey(id, scope) {
    return `${id}:${scope}`;
}
/**
 ...
 */
export function computeBaseSkipScope(baseId, currentId, currentScope) {
...
export function getDefaultAgentDefinitionsRoots(runtime, workspacePath) {
    if (!workspacePath) {
...
export async function discoverAgentDefinitions(runtime, workspacePath, options) {
    if (!workspacePath) {
    ...
    for (const scan of scans) {
        ...
        const filenames = runtime instanceof SSHRuntime
...
export async function readAgentDefinition(runtime, workspacePath, agentId, options) {
    if (!workspacePath) {
 ...
 */
export async function resolveAgentBody(runtime, workspacePath, agentId, options) {
 ...
 */
export async function resolveAgentFrontmatter(runtime, workspacePath, agentId, options) {
    if (!workspacePath) {
