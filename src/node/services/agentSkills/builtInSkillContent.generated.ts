...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  "agent-browser": {
    ...
    "SKILL.md": [
      ...
      "",
      "<!--",
      "Mux already vendors the agent-browser binary, so the default browser automation skill",
      "must ship with the app instead of depending on an external skill checkout.",
      "-->",
      "",
  ...
  "mux-docs": {
    ...
    "references/docs/agents/agent-skills.mdx": [
      ...
      "",
      "For example, `agent-browser` ships as a built-in skill by default, but you can still override it by creating an `agent-browser` skill in any higher-precedence workspace-local or global root.",
      "",
      "<Info>",
