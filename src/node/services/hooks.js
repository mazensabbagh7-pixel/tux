...
const TOOL_INPUT_ENV_LIMIT = 8000;
const FLATTENED_TOOL_ENV_MAX_VARS = 200;
const FLATTENED_TOOL_ENV_MAX_ARRAY_LENGTH = 50;
const DEFAULT_HOOK_PHASE_TIMEOUT_MS = 10000; // 10 seconds
 ...
 */
export async function getHookPath(runtime, projectDir) {
 ...
 */
export async function getToolEnvPath(runtime, projectDir) {
 ...
 */
export async function getPreHookPath(runtime, projectDir) {
 ...
 */
export async function getPostHookPath(runtime, projectDir) {
 ...
 */
export async function runWithHook(runtime, hookPath, context, executeTool, timingOptions) {
 ...
 */
export async function runPreHook(runtime, hookPath, context, options) {
 ...
 */
export async function runPostHook(runtime, hookPath, context, toolResult, options) {
    const timeoutMs = options?.timeoutMs ?? DEFAULT_HOOK_PHASE_TIMEOUT_MS;
