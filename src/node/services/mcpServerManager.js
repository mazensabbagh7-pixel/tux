...
import { parseBearerWwwAuthenticate } from "@/node/services/mcpOauthService";
    ...
    const testPromise = (async () => {
        ...
        try {
            if (server.transport === "stdio") {
                ...
                const tryHttp = async () => createMCPClient({
                    transport: {
                        type: "http",
                        ...transportBase,
                    },
                });
                const trySse = async () => createMCPClient({
                    transport: {
                        type: "sse",
                        ...transportBase,
                    },
...
export class MCPServerManager {
    ...
    constructor(configService, options, policyService) {
        ...
        this.workspaceLeases = new Map();
        this.inlineServers = {};
        this.mcpOauthService = null;
        this.ignoreConfigFile = false;
