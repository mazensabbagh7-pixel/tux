...
describe("MessageQueue", () => {
    ...
    describe("getDisplayText", () => {
        ...
        it("should throw when adding compaction after normal message", () => {
            ...
            expect(() => queue.add("Summarize this conversation...", options)).toThrow(/Cannot queue compaction request/);
        });
    ...
    describe("multi-message batching", () => {
        ...
        it("should throw when adding agent-skill invocation after normal message", () => {
            ...
            expect(() => queue.add("Using skill init", options)).toThrow(/Cannot queue agent skill invocation/);
        });
        it("should throw when adding normal message after agent-skill invocation", () => {
            ...
            expect(() => queue.add("Follow-up message")).toThrow(/agent skill invocation is already queued/);
        });
        ...
        it("should batch messages with mixed images", () => {
            ...
            expect(queue.getDisplayText()).toBe("Message with image\nFollow-up without image\nAnother with image");
        });
    });
