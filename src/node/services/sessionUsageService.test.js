...
describe("SessionUsageService", () => {
    ...
    describe("getSessionUsage", () => {
        it("should rebuild from messages when file missing (ENOENT)", async () => {
            ...
            await historyService.appendToHistory(workspaceId, createMuxMessage("msg1", "assistant", "Hello", {
                model: "claude-sonnet-4-20250514",
                usage: { inputTokens: 100, outputTokens: 50, totalTokens: 150 },
            }));
            await historyService.appendToHistory(workspaceId, createMuxMessage("msg2", "assistant", "World", {
                model: "claude-sonnet-4-20250514",
