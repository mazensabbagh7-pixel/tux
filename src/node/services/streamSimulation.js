 ...
 */
export async function simulateContextLimitError(ctx, historyService) {
    ...
    ctx.emit("error", createErrorEvent(ctx.workspaceId, {
        messageId: ctx.assistantMessageId,
        error: errorMessage,
        errorType: "context_exceeded",
    }));
 ...
 */
export async function simulateToolPolicyNoop(ctx, effectiveToolPolicy, historyService) {
