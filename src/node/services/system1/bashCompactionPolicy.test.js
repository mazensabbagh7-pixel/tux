...
import { classifyBashIntent, decideBashOutputCompaction, isBashOutputAlreadyTargeted, } from "./bashCompactionPolicy";
describe("bashCompactionPolicy", () => {
    ...
    describe("classifyBashIntent", () => {
        it("classifies exploration via display name keywords", () => {
            expect(classifyBashIntent({ script: "echo hi", displayName: "List files" })).toBe("exploration");
