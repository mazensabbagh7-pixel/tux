...
const createSessionMock = mock((params, _runtime, _path, onData, _onExit, _runtimeConfig, _options) => {
...
describe("TerminalService", () => {
    ...
    it("should respond to DA1 terminal queries on the backend", async () => {
        ...
        mockPTYService.createSession = mock((params, _runtime, _path, onData, _onExit) => {
    ...
    it("should handle session exit", async () => {
        ...
        // Override mock temporarily for this test
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        mockPTYService.createSession = mock((params, _runtime, _path, _onData, onExit) => {
...
describe("TerminalService.openNative", () => {
    ...
    beforeEach(() => {
        ...
        spawnSpy = spyOn(childProcess, "spawn").mockImplementation((() => createMockChildProcess()));
    ...
    describe("error handling", () => {
        ...
        it("should throw error for non-existent workspace", async () => {
            service = new TerminalService(configWithLocalWorkspace, mockPTYService);
            // eslint-disable-next-line @typescript-eslint/await-thenable
            await expect(service.openNative("non-existent")).rejects.toThrow("Workspace not found: non-existent");
        });
    });
});
