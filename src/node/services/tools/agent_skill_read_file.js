...
import { readAgentSkill, resolveAgentSkillFilePath, } from "@/node/services/agentSkills/agentSkillsService";
 ...
 */
export const createAgentSkillReadFileTool = (config) => {
    return tool({
        ...
        execute: async ({ name, filePath, offset, limit }) => {
            ...
            try {
                ...
                const targetPath = resolveAgentSkillFilePath(config.runtime, resolvedSkill.skillDir, filePath);
                let stat;
                try {
