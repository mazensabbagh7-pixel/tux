 ...
 */
export async function validatePlanModeAccess(filePath, config) {
 ...
 */
export async function isPlanFilePath(targetPath, config) {
 ...
 */
export function validateFileSize(stats) {
 ...
 */
export function validateNoRedundantPrefix(filePath, cwd, runtime) {
 ...
 */
export function validatePathInCwd(filePath, cwd, runtime, extraAllowedDirs = []) {
 ...
 */
export function validateAndCorrectPath(filePath, cwd, runtime) {
