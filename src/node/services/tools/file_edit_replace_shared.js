 ...
 */
import { EDIT_FAILED_NOTE_PREFIX, NOTE_READ_FILE_FIRST_RETRY, NOTE_READ_FILE_RETRY, NOTE_READ_FILE_AGAIN_RETRY, } from "@/common/types/tools";
import { convertNewlines, detectFileEol, normalizeNewlinesToLF } from "./eol";
/**
 * Handle string-based replacement
 */
export function handleStringReplace(args, originalContent) {
 ...
 */
export function handleLineReplace(args, originalContent) {
