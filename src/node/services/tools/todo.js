...
function validateTodos(todos) {
    ...
    if (todos.length > MAX_TODOS) {
        throw new Error(`Too many TODOs (${todos.length}/${MAX_TODOS}). ` +
 ...
 */
export const createTodoWriteTool = (config) => {
    return tool({
 ...
 */
export const createTodoReadTool = (config) => {
    return tool({
 ...
 */
export async function setTodosForSessionDir(workspaceId, workspaceSessionDir, todos) {
    await writeTodos(workspaceId, workspaceSessionDir, todos);
}
/**
 * Get todos for a workspace session directory (useful for testing)
 */
export async function getTodosForSessionDir(workspaceSessionDir) {
 ...
 */
export async function clearTodosForSessionDir(workspaceId, workspaceSessionDir) {
