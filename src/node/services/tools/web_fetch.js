...
import { WEB_FETCH_TIMEOUT_SECS, WEB_FETCH_MAX_OUTPUT_BYTES, WEB_FETCH_MAX_HTML_BYTES, } from "@/common/constants/toolLimits";
import { execBuffered } from "@/node/utils/runtime/helpers";
import { downloadFromMuxMd, getMuxMdAllowedHosts, isMuxMdUrl, parseMuxMdUrl, } from "@/common/lib/muxMd";
 ...
 */
export const createWebFetchTool = (config) => {
    return tool({
