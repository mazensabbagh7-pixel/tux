...
import { buildStreamErrorEventData, coerceStreamErrorTypeForMessage, createErrorEvent, createStreamErrorMessage, createUnknownSendMessageError, formatSendMessageError, } from "./sendMessageError";
...
describe("createUnknownSendMessageError", () => {
    ...
    test("strips 'undefined: ' prefix from error messages", () => {
        const result = createUnknownSendMessageError("undefined: The document file name can only contain alphanumeric characters");
