 ...
 */
export async function findAvailableCommand(commands) {
...
export const GUI_EDITORS = ["cursor", "code", "zed", "subl"];
/** Terminal editors that require a terminal session */
export const TERMINAL_EDITORS = ["nvim", "vim", "vi", "nano", "emacs"];
/** All known GUI terminal emulators */
export const TERMINAL_EMULATORS = ["ghostty", "kitty", "alacritty", "wezterm", "iterm2"];
