...
import { isV3Usage, flatUsageToV3, normalizeFinishReason, normalizeGatewayGenerateResult, normalizeGatewayStreamUsage, } from "./gatewayStreamNormalization";
describe("isV3Usage", () => {
...
describe("normalizeGatewayStreamUsage", () => {
    async function collectStream(chunks) {
        ...
        const result = [];
        const transformed = stream.pipeThrough(normalizeGatewayStreamUsage());
