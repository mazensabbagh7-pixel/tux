...
const BASH_PATH_ERROR_COOLDOWN_MS = 30000;
let cachedBashPath = null;
let cachedBashPathError = null;
const defaultExecSync = (command, options) => execSync(command, options);
...
export function getBashPathForPlatform(params) {
 ...
 */
export function getBashPath(params = {}) {
...
export function resetBashPathCache() {
    cachedBashPath = null;
    cachedBashPathError = null;
}
/**
 ...
 */
export function isBashAvailable() {
    try {
        getBashPath();
        return true;
    }
