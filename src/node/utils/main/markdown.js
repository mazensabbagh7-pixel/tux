 ...
 */
export function extractModelSection(markdown, modelId) {
    if (!markdown || !modelId)
        return null;
 ...
 */
export function extractToolSection(markdown, toolName) {
...
export function stripScopedInstructionSections(markdown) {
    if (!markdown)
        return markdown;
