...
import { sanitizeAnthropicDocumentFilename, sanitizeAnthropicPdfFilenames, } from "./sanitizeAnthropicDocumentFilename";
...
describe("sanitizeAnthropicPdfFilenames", () => {
    ...
    it("does not mutate original messages", () => {
        ...
        expect(messages[0].parts[1].filename).toBe(originalFilename);
    });
    ...
    it("handles case-insensitive media type matching", () => {
        ...
        const result = sanitizeAnthropicPdfFilenames(messages);
        expect(result[0].parts[0].filename).toBe("test pdf");
    });
