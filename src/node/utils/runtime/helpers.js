 ...
 */
export async function execBuffered(runtime, command, options) {
 ...
 */
export async function readFileString(runtime, path, abortSignal) {
 ...
 */
export async function writeFileString(runtime, path, content, abortSignal) {
 ...
 */
export async function readPlanFile(runtime, workspaceName, projectName, workspaceId) {
 ...
 */
export async function hasNonEmptyPlanFile(runtime, workspaceName, projectName, workspaceId) {
 ...
 */
export async function movePlanFile(runtime, oldWorkspaceName, newWorkspaceName, projectName) {
    const muxHome = runtime.getMuxHome();
 ...
 */
export async function copyPlanFile(runtime, sourceWorkspaceName, sourceWorkspaceId, targetWorkspaceName, projectName) {
    const muxHome = runtime.getMuxHome();
