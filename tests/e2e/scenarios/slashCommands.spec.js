...
import { MOCK_COMPACTION_SUMMARY_PREFIX, MOCK_SLASH_COMMAND_PROMPTS, MOCK_TOOL_FLOW_PROMPTS, } from "../mockAiPrompts";
...
test.describe("slash command flows", () => {
    ...
    test("slash command /model sonnet switches models for subsequent turns", async ({ ui, page }) => {
        ...
        await ui.chat.expectTranscriptContains("Claude Sonnet 4.5 is now responding with standard reasoning capacity.");
    });
});
//# sourceMappingURL=slashCommands.spec.js.map