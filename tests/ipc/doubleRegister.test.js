...
describeIntegration("Service double registration", () => {
    test.concurrent("should not throw when register() is called multiple times", async () => {
    ...
    test.concurrent("should allow multiple register() calls without errors", async () => {
        const env = await createTestEnvironment();
        try {
...
//# sourceMappingURL=doubleRegister.test.js.map