 ...
 */
export function createTestRuntime(type, workdir, sshConfig, dockerConfig) {
    switch (type) {
        case "local": {
...
export class TestWorkspace {
    constructor(runtime, workspacePath, isRemote) {
     ...
     */
    static async create(runtime, type) {
        ...
        if (isRemote) {
            ...
            const workspacePath = type === "ssh" ? `/home/testuser/workspace/${testId}` : `/src/${testId}`;
 ...
 */
export function getSSHEnv(_sshConfig) {
