...
describeIntegration("Custom Models", () => {
    ...
    test("updateModelsOptimistically return is safe to persist", async () => {
        ...
        const view = render(React.createElement(APIProvider, {
            client: env.orpc,
        ...
        try {
            await waitFor(() => {
                if (!done)
                    throw new Error("Harness did not complete");
            }, { timeout: 10000 });
...
//# sourceMappingURL=customModels.test.js.map