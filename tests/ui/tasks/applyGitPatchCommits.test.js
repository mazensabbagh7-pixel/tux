...
async function seedHistory(historyService, workspaceId) {
    const userMessage = createMuxMessage("user-1", "user", "Apply the patch from task-fe-001");
    const taskApplyGitPatchToolMessage = createMuxMessage("assistant-task-apply-git-patch", "assistant", "", undefined, [
        {
            type: "dynamic-tool",
...
//# sourceMappingURL=applyGitPatchCommits.test.js.map